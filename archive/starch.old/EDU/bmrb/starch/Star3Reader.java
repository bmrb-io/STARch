 ...
 * @author  dmaziuk
 */
public class Star3Reader implements EDU.bmrb.sansj.ContentHandler,
...
//******************************************************************************
     ...
     * @param lt LoopTable
     */
    public Star3Reader( LoopTable lt ) {
        fLt = lt;
...
if( DEBUG ) System.err.println( fBuf );
    ...
    public static void main(String[] args) {
        ...
        Star3Reader r = new Star3Reader( t );
        try {
            t.connect();
            t.createTable();
            java.io.Reader in;
        ...
        try {
            ...
            for( i = 0; i < LoopTable.LOOP_TAGS3.length; i++ )
                if( LoopTable.LOOP_TAGS3[i].equals( node.getName() ) ) {
                    fLt.set( fRowNum, i, node.getValue() );
                    break;
                }
        }
        catch( Exception e ) {
