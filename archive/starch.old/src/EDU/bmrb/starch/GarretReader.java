 ...
 * All Rights Reserved.
 *
 * FILE:        $Source: /cvs_archive/cvs/starch/src/EDU/bmrb/starch/GarretReader.java,v $
 * 
...
// insert row
            ...
            e.printStackTrace();
            fOk = false;
            fMessage = "DB error at line " + lineno + "(" + stat + "): " + e.getMessage();
        }
            ...
            ie.printStackTrace();
            fOk = false;
            fMessage = "I/O error at line " + lineno + "(" + stat + "): " + ie.getMessage();
        }
    } //************************************************************************
