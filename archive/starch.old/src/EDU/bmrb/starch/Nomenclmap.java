 ...
 * All Rights Reserved.
 *
 * FILE:        $Source: /cvs_archive/cvs/starch/src/EDU/bmrb/starch/Nomenclmap.java,v $
 * 
...
//******************************************************************************
    ...
    String atom, ErrorList errs ) {
        try {
if( DEBUG ) System.err.println( "Convert atom " + seqno + ":" + residue + ":" + atom );
            int [] atoms = null;
            int [] pseudo = null;
            int bmrbnomid = fRefDb.getNomenclatureId( "BMRB" );
            String str = atom.toUpperCase();
            atom = fRefDb.convertAnyAtom( residue, str );
if( DEBUG ) System.err.println( "Converted atom: " + atom + " ("+ str + ")" );
            if( ! atom.equals( str ) ) {
...
if( DEBUG ) System.err.println( "Pseudo atom: " + atom );
                    errs.addWarning( seqno, residue, atom, "Expanding pseudoatom" );
